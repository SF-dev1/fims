...
var Ajio = function () {
    ...
    function viewOrder_handeleTable(type, tab) {
        ...
        oTable = table.DataTable({
            ...
            searchDelay: 500,
            ajax: {
                url: "ajax_load.php?action=get_orders&type=" + type + "&handler=" + handler + "&token=" + new Date().getTime(),
                cache: false,
                type: "GET",
                beforeSend: function () {
                    if (currentRequest != null) {
        ...
        function order_import_payments_handleValidation() {
            ...
            form1.validate({
                ...
                submitHandler: function (form) {
                    ...
                    $('.form-actions .btn-submit i', form1).addClass('fa fa-sync fa-spin');
                    var ajio_account = $('#ajio_account option:selected', form1).val();
                    var startDate = $('#start_date', form1).val();
                    var endDate = $('#end_date', form1).val();

                    var formData = new FormData();

                    formData.append('action', 'insert_settlements');
                    formData.append('start_date', startDate);
                    formData.append('end_date', endDate);
                    formData.append('ajio_account', ajio_account);
