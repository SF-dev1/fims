...
$.extend($.fn.dataTableExt.oStdClasses, {
    ...
    "sFilterInput": "form-control input-medium input-inline",
    ...
    "bootstrap_extended": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                ...
                '<a href="#" class="btn btn-sm btn-default prev disabled" title="' + oLang.previous + '"><i class="fa fa-angle-left"></i></a>' +
                ...
                '<a href="#" class="btn btn-sm btn-default next disabled" title="' + oLang.next + '"><i class="fa fa-angle-right"></i></a> ' +
