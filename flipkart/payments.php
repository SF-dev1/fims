										...
										<div class="fileinput fileinput-new" data-provides="fileinput">
											<span class="btn btn-default btn-file">
												...
												<span class="fileinput-exists">
													Change </span>
												<input type="file" name="orders_csv" accept=".xlsx" id="orders_csv">
											</span>
			...
			<div class="page-toolbar">
				<div class="btn-group pull-right">
					...
					<ul class="dropdown-menu pull-right" role="menu">
						<li>
							<a href="#" data-target="#import_payment_sheet" id="import_payment_sheet" role="button" class="btn btn-inverse import_payment_sheet" data-toggle="modal">Upload Payment Sheet &nbsp;</a>
						</li>
						<li>
								...
								<table class="table table-striped table-bordered table-hover" id="payment_disputed">
									<thead>
										<tr>
											...
											<th>Difference</th>
											<th>Incident ID</th>
											<th class="td-x-scroll">Tags</th>
											<th class="return_hide_column">Order ID</th>
											<th class="return_hide_column">Account ID</th>
										</tr>
									</thead>
									<tbody>
