            ...
            <div class="col-md-12">
                ...
                <div class="tabbable tabbable-custom boxless">
                    <ul class="nav nav-tabs order_type">
                        <li class="active"><a href="#portlet_received" data-toggle="tab">Received <span class="portlet_received count"></span></a></li>
                        <li><a href="#portlet_repair_payment_pending" data-toggle="tab">Repair Payment Pending <span class="portlet_repair_payment_pending count"></span></a></li>
                        <li><a href="#portlet_repair_in_progress" data-toggle="tab">Repair In Progress <span class="portlet_repair_in_progress count"></span></a></li>
                        <li><a href="#portlet_pending_estimate_approval" data-toggle="tab">Pending Estimate Approval <span class="portlet_pending_estimate_approval count"></span></a></li>
                        <li><a href="#portlet_qc_in_progress" data-toggle="tab">QC In Progress <span class="portlet_qc_in_progress count"></span></a></li>
                        <li><a href="#portlet_completed" data-toggle="tab">Completed <span class="portlet_completed count"></span></a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="portlet_received">
                            <table class="table table-striped table-bordered table-hover" id="selectable_shopify_received_repairs"></table>
                        </div>
                        <div class="tab-pane" id="portlet_repair_payment_pending">
                            <table class="table table-striped table-bordered table-hover" id="selectable_shopify_repair_payment_pending_repairs"></table>
                        </div>
                        <div class="tab-pane" id="portlet_repair_in_progress">
                            <table class="table table-striped table-bordered table-hover" id="selectable_shopify_repair_in_progress_repairs"></table>
                        </div>
                        <div class="tab-pane" id="portlet_pending_estimate_approval">
                            <table class="table table-striped table-bordered table-hover" id="selectable_shopify_pending_estimate_approval_repairs"></table>
                        </div>
                        <div class="tab-pane" id="portlet_qc_in_progress">
                            <table class="table table-striped table-bordered table-hover" id="selectable_shopify_qc_in_progress_repairs"></table>
                        </div>
                        <div class="tab-pane" id="portlet_completed">
                            <table class="table table-striped table-bordered table-hover" id="selectable_shopify_completed_repairs"></table>
                        </div>
                    </div>
                </div>
            </div>
