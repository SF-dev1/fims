            ...
            <div class="col-md-12">
                ...
                <div class="tabbable tabbable-custom boxless">
                    <ul class="nav nav-tabs order_type">
                        <li class="active"><a href="#portlet_pending_pickup" data-toggle="tab">Pickup Pending <span class="portlet_pending_pickup count"></span></a></li>
                        ...
                        <li><a href="#portlet_packing" data-toggle="tab">Packing <span class="portlet_packing count"></span></a></li>
                        <li><a href="#portlet_ready_to_dispatch" data-toggle="tab">Ready to Dispatch <span class="portlet_ready_to_dispatch count"></span></a></li>
                        <li><a href="#portlet_shipped" data-toggle="tab">Shipped <span class="portlet_shipped count"></span></a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="portlet_pending_pickup">
                            <table class="table table-striped table-bordered table-hover" id="selectable_shopify_pending_pickup_reship"></table>
                        </div>
                        <div class="tab-pane" id="portlet_in_transit">
                            <table class="table table-striped table-bordered table-hover" id="selectable_shopify_in_transit_reship"></table>
                        </div>
                        <div class="tab-pane" id="portlet_delivered">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="selectable_shopify_delivered_reship"></table>
                        </div>
                        <div class="tab-pane" id="portlet_packing">
                            <table class="table table-striped table-bordered table-hover" id="selectable_shopify_packing_reship"></table>
                        </div>
                        <div class="tab-pane" id="portlet_ready_to_dispatch">
                            <table class="table table-striped table-bordered table-hover" id="selectable_ready_to_dispatch_reship"></table>
                        </div>
                        <div class="tab-pane" id="portlet_shipped">
                            <table class="table table-striped table-bordered table-hover" id="selectable_shipped_reship"></table>
                        </div>
