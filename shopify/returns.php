				...
				<div class="tabbable tabbable-custom boxless">
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="portlet_received">
							...
							<table class="table table-striped table-bordered table-hover" id="selectable_shopify_received_return"></table>
						</div>
						<div class="tab-pane" id="portlet_claimed">
							<table class="table table-striped table-bordered table-hover" id="selectable_shopify_claimed_return"></table>
						</div>
						<div class="tab-pane" id="portlet_completed">
							<table class="table table-striped table-bordered table-hover" id="selectable_shopify_completed_return"></table>
						</div>
					</div>
				</div>
			</div>
