...
<head>
	...
	<link async href="https://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700|Nunito:300,400,400i,600,700&subset=all" rel="stylesheet" type="text/css" />
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown user">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
								...
								<span class="username username-hide-on-mobile"><?php echo $current_user['display_name'] ?> </span>
								<i class="fa fa-angle-down"></i>
							</a>
							<ul class="dropdown-menu">
								<li>
									<a href="<?php echo BASE_URL ?>/users/profile.php"><i class="fa fa-user"></i> My Profile</a>
								</li>
								<!-- <li>
