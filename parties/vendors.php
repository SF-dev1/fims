...
<div class="page-content-wrapper">
	<div class="page-content">
					...
					<div class="modal-body form">
						<form action="#" type="post" class="form-horizontal form-row-seperated" name="add-party" id="add-party">
							<div class="form-body">
								...
								<div class="form-group">
									<label class="col-sm-4 control-label">Rate per Order<span class="required"> * </span></label>
									<div class="col-sm-8">
										<div class="input-inline input-medium">
											<input type="number" id="party_por" name="party_ams_rates_por" required class="form-control" step="0.01" min="0" max="50">
										</div>
										<span class="help-block">(Excluding GST)</span>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">Share on Revenue<span class="required"> * </span></label>
									<div class="col-sm-8">
										<div class="input-inline input-medium">
											<input type="number" id="party_sor" name="party_ams_rates_sor" required class="form-control" min="0" max="50">
										</div>
									</div>
								</div>
									...
									<div class="col-sm-8">
										<div class="checkbox-list">
											<label class="checkbox-inline">
												<input type="checkbox" checked id="party_type_supplier" name="party_type_supplier" value="1" class="form-control"> Supplier </label>
											<label class="checkbox-inline">
												<input type="checkbox" checked id="party_type_ams" name="party_type_ams" value="1" class="form-control"> AMS Vendor </label>
										</div>
									</div>
								</div>
		...
		<!-- BEGIN PAGE HEADER-->
		<h3 class="page-title">
			Parties <small>AMS Vendors</small>
		</h3>
		<div class="page-bar">
			...
			<div class="col-md-12 table-responsive">
				...
				<div class="portlet">
					...
					<div class="portlet-body">
						<table class="table table-striped table-hover table-bordered" id="editable_vendors"></table>
					</div>
				</div>
