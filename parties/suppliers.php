									...
									<div class="col-sm-8">
										<div class="checkbox-list">
											<label class="checkbox-inline">
												<input type="checkbox" id="party_type_supplier" name="party_type_supplier" value="1" class="form-control"> Supplier </label>
											<label class="checkbox-inline">
												<input type="checkbox" id="party_type_carrier" name="party_type_carrier" value="1" class="form-control"> Carrier </label>
										</div>
									</div>
								</div>
			...
			<div class="col-md-12 table-responsive">
				...
				<div class="portlet">
					...
					<div class="portlet-body">
						<table class="table table-striped table-hover table-bordered" id="editable_suppliers"></table>
					</div>
				</div>
