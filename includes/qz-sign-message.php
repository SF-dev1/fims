...
// var_dump(strpos($_SERVER['SERVER_NAME'], 'skmienterprise.com') !== FALSE);
if (strpos($_SERVER['SERVER_NAME'], 'skmienterprise.com') !== FALSE)
	$KEY = '../assets/certificates-live/private-key.pem';
else
	$KEY = '../assets/certificates/private-key.pem';
