...
// global $accounts;
// $aj_account_options = '<option value=""></option>';
// foreach ($accounts['ajio'] as $account) {
// 	$aj_account_options .= '<option value="' . $account->account_id . '">' . $account->account_name . '</option>';
// }	
?>
<!-- BEGIN CONTENT -->
				...
				<div class="tabbable tabbable-custom boxless">
					...
					<div class="tab-content">
						<div class="tab-pane" id="portlet_pending">
							<table class="table table-striped table-bordered table-hover" id="selectable_ajio_pending_order"></table>
						</div>
						<div class="tab-pane active" id="portlet_new">
							...
							<table class="table table-striped table-bordered table-hover" id="selectable_ajio_new_order"></table>
						</div>
						<div class="tab-pane" id="portlet_packing">
							...
							<table class="table table-striped table-bordered table-hover" id="selectable_ajio_packing_order"></table>
						</div>
						<div class="tab-pane" id="portlet_rtd">
							<div class="clearfix margin-bottom-10 grp-process">
								<div class="btn-group">
									<a href="#order_status_update" role="button" class="btn btn-success btn-modal" data-updatetype="shipped" data-toggle="modal">Mark Shipped</a>
								</div>
							</div>
							<table class="table table-striped table-bordered table-hover" id="selectable_ajio_rtd_order"></table>
						</div>
						<div class="tab-pane" id="portlet_shipped">
							<table class="table table-striped table-bordered table-hover" id="selectable_ajio_shipped_order"></table>
						</div>
						<div class="tab-pane" id="portlet_cancelled">
							<table class="table table-striped table-bordered table-hover" id="selectable_ajio_cancelled_order"></table>
						</div>
					</div>
				</div>
			</div>
