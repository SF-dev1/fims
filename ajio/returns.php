				...
				<div class="tabbable tabbable-custom boxless">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="portlet_start">
							<table class="table table-striped table-bordered table-hover" id="selectable_ajio_start_return"></table>
						</div>
						<div class="tab-pane" id="portlet_in_transit">
							<table class="table table-striped table-bordered table-hover" id="selectable_ajio_in_transit_return"></table>
						</div>
						<div class="tab-pane" id="portlet_out_for_delivery">
							<table class="table table-striped table-bordered table-hover" id="selectable_ajio_out_for_delivery_return"></table>
						</div>
						<div class="tab-pane" id="portlet_delivered">
							...
							<table class="table table-striped table-bordered table-hover" id="selectable_ajio_delivered_return"></table>
						</div>
						<div class="tab-pane" id="portlet_received">
							...
							<table class="table table-striped table-bordered table-hover" id="selectable_ajio_received_return"></table>
						</div>
						<div class="tab-pane" id="portlet_claimed">
							<table class="table table-striped table-bordered table-hover" id="selectable_ajio_claimed_return"></table>
						</div>
						<div class="tab-pane" id="portlet_completed">
							<table class="table table-striped table-bordered table-hover" id="selectable_ajio_completed_return"></table>
						</div>
					</div>
				</div>
			</div>
